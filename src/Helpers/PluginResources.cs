namespace Loupedeck.FotoPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.FotoPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.FotoPlugin.Resources.Resource.txt`.
